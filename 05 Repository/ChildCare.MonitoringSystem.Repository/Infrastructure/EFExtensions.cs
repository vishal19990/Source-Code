...
namespace ChildCare.MonitoringSystem.Repository
{
    public static class EFExtensions
    {
        ...
        /// <returns></returns>
        public static void ExecuteStoredProc(this DbCommand command, DbTransaction activeTransaction, Action<SprocResults> handleResults, System.Data.CommandBehavior commandBehaviour = System.Data.CommandBehavior.Default)
        {
        ...
        /// <param name="command"></param>
        /// <returns></returns>
        public async static Task ExecuteStoredProcAsync(this DbCommand command, DbTransaction currentTransaction, Action<SprocResults> handleResults, System.Data.CommandBehavior commandBehaviour = System.Data.CommandBehavior.Default, CancellationToken ct = default(CancellationToken))
        {
            if (handleResults == null)
            {
                throw new ArgumentNullException(nameof(handleResults));
